...
const Hero = () => {
  ...
  return (
    ...
    <div ref={heroRef} className="hero">
      <div className='row-2'>
        <img ref={imgRef} src='/photo-1748795303121-02b90e036dec.avif' style={{ transformOrigin: "center center" }}></img>
      </div>
